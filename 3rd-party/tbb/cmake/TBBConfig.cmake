...
foreach (_tbb_component ${TBB_FIND_COMPONENTS})
    ...
    set(_tbb_release_lib "/home/huangruixin/repo/taskflow/build/benchmarks/tbb_cmake_build/tbb_cmake_build_subdir_release/lib${_tbb_component}.so.2")

    if (NOT TBB_FIND_RELEASE_ONLY)
        set(_tbb_debug_lib "/home/huangruixin/repo/taskflow/build/benchmarks/tbb_cmake_build/tbb_cmake_build_subdir_debug/lib${_tbb_component}_debug.so.2")
    endif()
